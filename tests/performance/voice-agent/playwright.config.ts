...
export default defineConfig({
  testDir: ".",
  testMatch: "voice-agent-performance.spec.ts",
  fullyParallel: false,
  workers: 1,
  retries: 0,
  reporter: "list",
  outputDir: "/tmp/homerounds-voice-agent-performance-results",
  timeout: 120_000,
